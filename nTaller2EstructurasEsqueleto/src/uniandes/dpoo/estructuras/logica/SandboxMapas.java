...
public class SandboxMapas
{
    ...
    public Collection<String> getLlaves( )
    {
        ...
        for (int i = 0; i < llaves.length; i++) {
            copia.add(llaves[i].toUpperCase());
        }
        return copia;
    }
    ...
    public void eliminarCadenaConValor( String valor )
    {
        ...
        for (int i = 0; i < entradas.size(); i++) {
            Map.Entry<String, String> entry = entradas.get(i);
    ...
    public void volverMayusculas( )
    {
        ...
        for (int i = 0; i < llaves.size(); i++) {
            String llaveOriginal = llaves.get(i);
            String valor = mapaCadenas.get(llaveOriginal);

            mapaCadenas.remove(llaveOriginal);      
            mapaCadenas.put(llaveOriginal.toUpperCase(), valor); 
        }
    ...
    public boolean compararValores( String[] otroArreglo )
    {
    	...
    	for (int i = 0; i < otroArreglo.length; i++) {
    	    if (conjuntoValores.contains(otroArreglo[i]) == false) {
    	        return false;
    	    }
    	}
