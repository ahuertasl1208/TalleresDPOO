...
public class SandboxArreglos
{
    ...
    {
    	arregloCadenas = Arrays.copyOf(arregloCadenas, getCantidadEnteros() + 1);
    ...
    public void eliminarEntero( int valor )
    {
    	...
    	int[] nArreglo = new int[size];
    	
    	int n = 0;
    	
    	for (int i = 0; i < arregloEnteros.length; i++ ) {
    		if (arregloEnteros[i] != valor) {
    			nArreglo[n] = arregloEnteros[i];
    			n++;
    		}
    	}
    ...
    public void eliminarCadena( String cadena )
    {
    	...
    	String[] nArreglo = new String[size];
    	
    	int n = 0;
    	
    	for (int i = 0; i < arregloCadenas.length; i++ ) {
    		if (arregloCadenas[i] != cadena) {
    			nArreglo[n] = arregloCadenas[i];
    			n++;
    		}
    	}
    ...
    public void insertarEntero( int entero, int posicion )
    {
    	...
    	int[] nArreglo = new int[arregloEnteros.length + 1];
		for (int i = 0; i < posicion; i++) {
			nArreglo[i] = arregloEnteros[i];
		}
		
		nArreglo[posicion] = entero;
		
		for (int i = posicion; i < arregloEnteros.length; i++) {
			nArreglo[i + 1] = arregloEnteros[i];
		}
    ...
    public HashMap<Integer, Integer> calcularHistograma( )
    {
        ...
        for (int i = 0; i < arregloEnteros.length; i++) {
            ...
            hist.put(v, hist.getOrDefault(v, 0) + 1);
        }
        return hist;
    }
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
    	...
    	for (int i = 0; i < cantidad; i++) {
    		arregloEnteros[i] = (int)(minimo + Math.random() * (maximo - minimo + 1));
    	}
